...
Skill ini digunakan untuk menghitung **VDOT** (estimasi VO₂max) dan **5 Zona Pace Latihan** dari hasil race atau sesi tempo menggunakan MCP tool `calculate_vdot` dan `calculate_pace_zones`.
