...
Skill ini digunakan untuk menganalisis efisiensi aerobik (*Efficiency Factor*) dan penurunan performa kardiovaskular (*Cardiac Drift*) dari sesi latihan lari atau sepeda.
